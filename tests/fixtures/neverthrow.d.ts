// AUTO-GENERATED by scripts/generate-fixtures.mjs from node_modules/neverthrow/dist/index.d.ts.
  ...
  IsLiteralArray<T> extends 1
    ...
    : T extends Array<infer A>
      ? A extends PromiseLike<infer HI>
        ...
        : never
      : never
declare type TraverseAsync<T, Depth extends number = 5> =
  IsLiteralArray<T> extends 1
    ...
    : T extends Array<infer I>
      ? Combine<MemberListOf<I>, Depth> extends [infer Oks, infer Errs]
        ...
        : never
      : never
declare type TraverseWithAllErrorsAsync<T, Depth extends number = 5> =
...
declare namespace Result {
  ...
  function combine<T extends readonly [Result<unknown, unknown>, ...Result<unknown, unknown>[]]>(
    resultList: T,
  ): CombineResults<T>
...
> = A extends [infer T, ...infer Rest]
  ? T extends [infer L, infer R]
    ...
    : Transposed
  : Transposed
declare type Combine<T, Depth extends number = 5> =
...
declare type MemberListOf<T> = (
  ...
  : []
declare type EmptyArrayToNever<T, NeverArrayToNever extends number = 0> = T extends []
  ? never
  : NeverArrayToNever extends 1
    ? T extends [never, ...infer Rest]
      ...
      : T
    : T
declare type UnknownMembersToNever<T> = T extends [infer H, ...infer R]
...
declare type IsLiteralArray<T> = T extends {
  ...
  ? L extends number
    ...
    : 0
  : 0
declare type Traverse<T, Depth extends number = 5> =
  Combine<T, Depth> extends [infer Oks, infer Errs]
    ? Result<EmptyArrayToNever<Oks, 1>, MembersToUnion<Errs>>
    : never
declare type TraverseWithAllErrors<T, Depth extends number = 5> =
  Traverse<T, Depth> extends Result<infer Oks, infer Errs> ? Result<Oks, Errs[]> : never
declare type CombineResults<T extends readonly Result<unknown, unknown>[]> =
  IsLiteralArray<T> extends 1 ? Traverse<T> : Result<ExtractOkTypes<T>, ExtractErrTypes<T>[number]>
declare type CombineResultsWithAllErrorsArray<T extends readonly Result<unknown, unknown>[]> =
  IsLiteralArray<T> extends 1
